function  mpc = case5_stagg_MTDCdroop
%% system MVA base
mpc.baseMVA = 100;
...
mpc.conv = [ 
    ...
    3  5  1       3       1        35      5    1     0.0015  0.1121  0.0887 0.0001   0.16428  345         1.1     0.9     1.2     1       1.103 0.887  2.885   4.371   0.0050     36.1856   0.9978   0;
];
...
mpc.branch = [
    1       2       0.052   0   0    000     000     000      0       0       1   -0   0;
    2       3       0.052   0   0    000     000     000      0       0       1   -0   0;
    1       3       0.073   0   0    000     000     000     0       0       1   -0   0;
];