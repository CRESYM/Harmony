...
function params_ac(acgrid_name::String, dcgrid_name::String)
    ...
    fbus_ac = Vector{Any}(undef, ngrids)
    tbus_ac = Vector{Any}(undef, ngrids)
    GG_ft_ac = Vector{Any}(undef, ngrids)
    BB_ft_ac = Vector{Any}(undef, ngrids)
    GG_tf_ac = Vector{Any}(undef, ngrids)
    BB_tf_ac = Vector{Any}(undef, ngrids)
