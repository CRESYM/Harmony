...
[![Windows build & test](https://github.com/CRESYM/Harmony/actions/workflows/windows_build_and_test.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/windows_build_and_test.yml?query=branch%3Amain) [![Linux build & test](https://github.com/CRESYM/Harmony/actions/workflows/linux_build_and_test.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/linux_build_and_test.yml?query=branch%3Amain) [![macOS build & test](https://github.com/CRESYM/Harmony/actions/workflows/macos_build_and_test.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/macos_build_and_test.yml?query=branch%3Amain)   
[![Windows run examples](https://github.com/CRESYM/Harmony/actions/workflows/windows_run_examples.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/windows_run_examples.yml?query=branch%3Amain) [![Linux run examples](https://github.com/CRESYM/Harmony/actions/workflows/linux_run_examples.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/linux_run_examples.yml?query=branch%3Amain) [![macOS run examples](https://github.com/CRESYM/Harmony/actions/workflows/macos_run_examples.yml/badge.svg?branch=main)](https://github.com/CRESYM/Harmony/actions/workflows/macos_run_examples.yml?query=branch%3Amain)   
