/**
 * @file example_OPF_WT.cpp
 * @brief Runnable example: OPF study including a wind-turbine plant.
 */
#include "Examples.h"
...
void example_OPF_WT(bool plotting_enabled /*=true*/)
{
    ...
    /* ---------- 1.1 Create AC Buses ---------- */
    Bus* bus1_ac = new Bus("ACBUS01", "AC1", 3); // WT side
    ...
    /* ---------- 1.3 Add Wind Turbines ---------- */
    std::vector<double> wt3_parameters = {
        1080.0,
        20e6,
        0.0644e-3,
        0.0092,
    ...
    WTtype3* wt1 = new WTtype3("WT3_01", "AC1", wt3_parameters);
    net.connectElementToBus(wt1, 1, bus1_ac);

    std::vector<double> wt4_parameters = {
        690,
        60.0,
        20e6,
        1000,
    ...
    WTtype4* wt2 = new WTtype4("WT4_01", "AC1", wt4_parameters);
    net.connectElementToBus(wt2, 1, bus1_ac);

    /* ---------- 1.4 Add AC Branches ---------- */
    std::complex<double> ACZ1(5, 140);
