...
void example_MMC() {
	...
	std::vector<double> converter_params = { omega, 100.0e6, 0, 0.0, 100.0e3, 200e3, 50e-3, 1.07, 0.01, 100, 0.06, 0.535, 0 };
	std::vector<double> controller_params = { 
		1, 0,001103374, 0,00073, 1, 0, // PLL controller parameters
		0,
		//1, 0.01, 2, 1, 200e3, // DC voltage controller parameters
