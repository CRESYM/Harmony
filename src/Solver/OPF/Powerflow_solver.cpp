...
//void PowerFlow::solve_opf(const std::string& dc_name, const std::string& ac_name,
...
void PowerFlow::solve_unified_opf(
    ...
    try {
        ...
        // Get references to all the member variables (same as in both original functions)
        auto& baseMW_dc = sys_dc.baseMW_dc;
        auto& pol_dc = sys_dc.pol_dc;
        auto& bus_dc = sys_dc.bus_dc;
        auto& branch_dc = sys_dc.branch_dc;
