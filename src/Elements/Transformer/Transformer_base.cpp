...
void Transformer_base::computePowerFlowAC(std::map<std::string, double>& branchData,
...
void Transformer_base::computePowerFlowDC(std::map<std::string, double>& branchDCData,
    const std::map<std::string, double>& globalParams) const
{
    using cd = std::complex<double>;
