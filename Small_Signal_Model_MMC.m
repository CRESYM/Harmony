...
R=1;%arm resistance
zl=283.73+(408.84*1i);%load from rated power and assumed power factor of 0.8 lag
...
% subplot(4,1,2)
% plot(t,xcuv_phat,t,xcuv_phbt,t,xcuv_phct)%capacitor voltage in the upper leg in phase A,B,C
% subplot(4,1,3)
% plot(t,xclv_phat,t,xclv_phbt,t,xclv_phct)%capacitor voltage in the lower leg in phase A,B,C
% subplot(4,1,4)
